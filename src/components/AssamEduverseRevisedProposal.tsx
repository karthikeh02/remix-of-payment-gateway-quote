...
const AssamEduverseRevisedProposal = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const opt = {
        margin: 0,
        filename: `Zan_Services_Assam_Eduverse_Revised_Quotation_${formatDate(currentDate).replace(/\//g, "-")}.pdf`,
  ...
  const services = [
    { service: "Final Sitemap Audit & Fix", description: "Complete audit of the existing XML sitemap — identify remaining missing pages, broken URLs, incorrect formats. Generate a clean, valid XML sitemap with all indexable pages and proper priority/frequency settings." },
    { service: "Google Search Console Indexing", description: "Submit corrected sitemap to Google Search Console, request indexing for all pages, monitor crawl stats & fix any reported errors to ensure full site coverage." },
    { service: "Robots.txt Verification", description: "Final review and fix of robots.txt to ensure no critical pages are accidentally blocked from crawling. Proper allow/disallow rules for Googlebot and other search engine bots." },
    { service: "Crawl Error Resolution", description: "Identify and resolve all remaining crawl errors reported in Google Search Console — including 404 errors, server errors, redirect issues, and soft 404s that prevent proper indexing." },
  ...
  const termsAndConditions = [
    "This is a revised quotation superseding the previous quote of \u20b99,000 + GST.",
    "This quotation is valid for 7 (seven) days from the date of issue.",
    "Payment terms: 100% advance payment before work begins.",
    "Project scope covers final sitemap fix, Google indexing resolution, and crawl error fixes as listed in this quotation.",
        ...
        <div className="quote-header-light relative z-10">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h1 className="text-3xl font-bold tracking-tight font-display text-quote-header-bg">Revised Quotation</h1>
              <p className="text-muted-foreground mt-1 text-sm">Final Sitemap Fixing & Google Indexing — Technical Resolution</p>
              <div className="quote-accent-bar mt-4"></div>
            </div>
            <div className="text-right">
              <span className="inline-block bg-amber-100 text-amber-800 text-xs font-semibold px-3 py-1 rounded-full mb-2 border border-amber-300">REVISED</span>
        ...
        <div className="px-10 py-8 relative z-10">
          ...
          <div className="quote-section">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-foreground">Scope of Work — Final Sitemap Fixing & Indexing</h2>
              <span className="quote-badge whitespace-nowrap">{"\u20b9"}5,500 + GST</span>
            </div>
            <div className="overflow-hidden rounded-lg border border-quote-border">
              <table className="w-full">
                <thead>
          ...
          <div className="quote-section">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="quote-badge whitespace-nowrap">3 Key Deliverables</span>
            </div>
            <div className="overflow-hidden rounded-lg border border-quote-border">
              <table className="w-full">
                <thead>
          ...
          <div className="my-8">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="inline-block bg-amber-100 text-amber-800 text-xs font-semibold px-3 py-1 rounded-full border border-amber-300">REVISED</span>
            </div>
            ...
            <div className="quote-total-box p-6 rounded-lg">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-white/80 text-sm uppercase tracking-wider">REVISED PROJECT COST</p>
                  <p className="text-xs text-white/60 mt-1">Final Sitemap Fixing & Google Indexing</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-white/50 line-through mb-1">{"\u20b9"}9,000/- + GST (Previous)</p>
                  <p className="text-3xl font-bold text-white">{"\u20b9"}5,500/- <span className="text-sm font-normal text-white/70">+ GST (18%)</span></p>
                  <p className="text-lg font-semibold mt-2 text-white/90">{"\u20b9"}6,490/- <span className="text-sm font-normal text-white/70">Including GST</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="bg-card border border-quote-border rounded-lg p-5 text-center">
                <p className="text-2xl font-bold text-primary">{"\u20b9"}5,500</p>
                <p className="text-xs font-semibold text-foreground mt-1">Revised Amount</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">Before GST</p>
              </div>
              <div className="bg-card border border-quote-border rounded-lg p-5 text-center">
                <p className="text-2xl font-bold text-primary">{"\u20b9"}6,490</p>
                <p className="text-xs font-semibold text-foreground mt-1">Total with GST</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">Including 18% GST</p>
              </div>
              <div className="bg-card border border-quote-border rounded-lg p-5 text-center">
            ...
            <div className="overflow-hidden rounded-lg border border-quote-border mt-5">
              <table className="w-full">
                ...
                <tbody>
                  <tr>
                    <td className="py-3 px-4 text-sm font-medium text-foreground">Final Sitemap Fixing & Google Indexing</td>
                    <td className="py-3 px-4 text-sm font-semibold text-foreground">{"\u20b9"}5,500/- + GST (One-Time)</td>
                  </tr>
                  ...
                  <tr className="quote-table-row-stripe border-t-2 border-quote-border">
                    <td className="py-3 px-4 text-sm font-bold text-foreground">Subtotal</td>
                    <td className="py-3 px-4 text-sm font-bold text-foreground">{"\u20b9"}5,500/-</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-sm font-medium text-foreground">GST @ 18%</td>
                    <td className="py-3 px-4 text-sm font-semibold text-foreground">{"\u20b9"}990/-</td>
                  </tr>
                  <tr className="quote-table-row-stripe">
                    <td className="py-3 px-4 text-sm font-bold text-foreground text-primary">Grand Total</td>
                    <td className="py-3 px-4 text-sm font-bold text-foreground text-primary">{"\u20b9"}6,490/-</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-xs text-muted-foreground leading-relaxed">
                  ...
                  <span>100% advance payment ({"\u20b9"}5,500 + GST = {"\u20b9"}6,490/-) before work begins — payable upon acceptance of this quotation.</span>
                </li>
                <li className="flex items-start gap-2 text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                  By signing below, the client acknowledges and accepts the revised terms, pricing, scope, and deliverables
                  outlined in this quotation for Final Sitemap Fixing & Google Indexing — Technical Services.
                </p>
              </div>
              <div className="text-right">
...
export default AssamEduverseRevisedProposal;
